...
export default function DoctorRegister() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Simulate registration delay with verification
    setTimeout(() => {
      setIsLoading(false)
        ...
        <div className="relative space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-muted-foreground">
              Join the MediChain network as a verified doctor
            </p>
          </div>

          {/* Verification Notice */}
          <div className="bg-accent/50 border border-primary/10 rounded-lg p-4">
            <div className="flex gap-3">
              <AlertCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
              <p className="text-xs text-muted-foreground leading-relaxed">
                All doctor registrations require medical license verification. Your account will be activated after verification is complete (typically 24-48 hours).
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="licenseId" className="text-sm font-semibold">
                Medical License ID
              </Label>
              <Input
                id="licenseId"
          ...
          <div className="space-y-4 pt-4 border-t">
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/doctor/login" className="text-primary hover:underline font-medium ml-1">
                Sign in
              </Link>
            </p>
